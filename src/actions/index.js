    ...
    return {
        ...
        payload: [
            ...
            },
            {
                ...
                description: "In this course you\'ll take a practical look at how to build a large number of software applications and features.  By taking a systems analysis and esign approach to development and leveraging UML, you\'ll be able to model systems and prepare to build the projects.",
                enrolled: false,
            },
            {
                id: 4,
            ...
            },
            {
                ...
                description: "This course teaches the fundamentals of programming and utilizes the Python programming langauge.",
                enrolled: false,
            },
            {
                id: 7,
                title: "TypeScript Development",
                description: "This course gives an introduction to the TypeScript programming language, including walking through the:  syntax, best practices, and practical systems for building TypeScirpt programs.",
                enrolled: false,
            },
            {
                id: 8,
